...
class HDM(Memory):
  ...
  def __init__(self,buffer,latency=0.05,threshold=-4.6,maximum_time=100.0,finst_size=4,finst_time=3.0, N=512, verbose=False, forgetting=1.0, noise=0.0):
...
#Can we convert the HDM class to a proper module? Let's find out
